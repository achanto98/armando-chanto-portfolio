    ...
    <footer className="border-t border-ink-700/60 py-10">
      <Container className="flex flex-col items-center justify-between gap-4 text-sm text-slate-500 sm:flex-row">
        ...
        <div className="flex gap-6">
          <a href="https://github.com/your-user" className="hover:text-accent" target="_blank" rel="noreferrer">
            GitHub
          </a>
          <a href="https://linkedin.com/in/your-user" className="hover:text-accent" target="_blank" rel="noreferrer">
            LinkedIn
          </a>
